...
public class RegionResourceIT {
     ...
     *
     * @see com.aida.uvspartenariats.repository.search.RegionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void deleteRegion() throws Exception {
        ...
        // Delete the region
        restRegionMockMvc
            .perform(delete("/api/regions/{id}", region.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
    ...
    public void searchRegion() throws Exception {
        ...
        // Search the region
        restRegionMockMvc
            .perform(get("/api/_search/regions?query=id:" + region.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(region.getId().intValue())))
            .andExpect(jsonPath("$.[*].regionName").value(hasItem(DEFAULT_REGION_NAME)));
