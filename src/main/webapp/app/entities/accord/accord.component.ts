...
export class AccordComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.accordService
        ...
        .subscribe(
          (res: HttpResponse<IAccord[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInAccords(): void {
    this.eventSubscriber = this.eventManager.subscribe('accordListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAccord[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
